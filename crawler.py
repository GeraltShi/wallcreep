...
class MainWindow(QWidget):
    ...
    def on_init(self):
        ...
        self.layout_top.setStretchFactor(self.button_prev, 3)
        self.layout_top.setStretchFactor(self.label_page, 1)
        self.layout_top.setStretchFactor(self.button_next, 3)
        self.layout_top.setStretchFactor(self.button_download, 3)
        ...
        self.setGeometry(810, 600, 300, 300)
